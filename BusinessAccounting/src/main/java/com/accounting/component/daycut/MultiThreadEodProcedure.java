...
public class MultiThreadEodProcedure extends EodProcedure{
	
	private static final Logger log = LoggerFactory.getLogger(MultiThreadEodProcedure.class);
...
//					.setMaxResults(100_0000)
			...
			latch.await(90, TimeUnit.MINUTES);//最长等待90分钟
			stopWatch.stop();
